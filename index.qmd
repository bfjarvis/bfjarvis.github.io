...
::: {.content-card-eyebrow}
2026 • assortative mating, discrete choice models, log-linear models, simulation, spatial analysis
:::

### [Discrete Choice Models (DCM) for Assortative Mating (AM), Part 1: Simulating a Marriage Market](blog/actors-and-locations/)
...
::: {.content-card-description}
The first note in a small series: create actors, quasi-random locations, group attractors, and a utility-based residential assignment.
:::
...
::: {.content-card-eyebrow}
2026 • conditional logit, loglinear models, assortative mating
:::

### [What Conditional Logit Can Use That a Group Table Cannot](blog/clogit-beyond-loglinear/)
...
::: {.content-card-description}
The fourth note in the series: add age gaps and distance to the conditional-logit model and compare this with conventional group-level loglinear analysis.
:::
...
::: {.content-card-eyebrow}
2026 • conditional logit, matching, assortative mating
:::

### [Does Conditional Logit Represent a Two-Sided Matching Process?](blog/clogit-two-sided-process/)
...
::: {.content-card-description}
The fifth note in the series: revisit what a one-sided choice model can and cannot recover from a two-sided stable matching process.
:::
